...
pub trait DiscoverApi: Send + Sync {
    ...
    ///
    ///
    async fn combined_applications(
        &self,
        params: CombinedApplicationsParams,
    ) -> Result<
        models::DomainDiscoverApiCombinedApplicationsResponse,
    ...
    ///
    ///
    async fn combined_hosts(
        &self,
        params: CombinedHostsParams,
    ...
    async fn query_logins(
        &self,
        params: QueryLoginsParams,
...
impl DiscoverApi for DiscoverApiClient {
            ...
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::DomainDiscoverApiCombinedApplicationsResponse`"
                    ))));
                }
            }
        } else {
    ...
    async fn combined_hosts(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::DomainDiscoverApiCombinedHostsResponse`"
                    ))));
                }
            }
        } else {
    ...
    async fn get_accounts(
        ...
        let GetAccountsParams { ids } = params;
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::DomainDiscoverApiAccountEntitiesResponse`"
                    ))));
                }
            }
        } else {
    ...
    {
        let GetApplicationsParams { ids } = params;
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::DomainDiscoverApiApplicationEntitiesResponse`"
                    ))));
                }
            }
        } else {
    ...
    async fn get_hosts(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::DomainDiscoverApiHostEntitiesResponse`"
                    ))));
                }
            }
        } else {
            let local_var_entity: Option<GetHostsError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
    ...
    async fn get_logins(
        ...
        let GetLoginsParams { ids } = params;
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::DomainDiscoverApiLoginEntitiesResponse`"
                    ))));
                }
            }
        } else {
