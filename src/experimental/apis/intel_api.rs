...
impl IntelApi for IntelApiClient {
    async fn get_intel_actor_entities(
        ...
        let GetIntelActorEntitiesParams { ids, fields } = params;
            ...
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::DomainActorsResponse`"
                    ))));
                }
            }
        } else {
    ...
    {
        let GetIntelIndicatorEntitiesParams { body } = params;
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::DomainPublicIndicatorsV3Response`"
                    ))));
                }
            }
        } else {
    ...
    async fn get_intel_report_entities(
        ...
        let GetIntelReportEntitiesParams { ids, fields } = params;
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::DomainNewsResponse`"
                    ))));
                }
            }
        } else {
    ...
    async fn get_intel_report_pdf(
        ...
        let GetIntelReportPdfParams { id, ids } = params;
    ...
    async fn get_intel_rule_entities(
        ...
        let GetIntelRuleEntitiesParams { ids } = params;
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::DomainRulesResponse`"
                    ))));
                }
            }
        } else {
    ...
    async fn get_intel_rule_file(
        ...
        let GetIntelRuleFileParams { id, accept, format } = params;
    ...
    async fn get_latest_intel_rule_file(
        ...
        if let Some(local_var_param_value) = if_modified_since {
            local_var_req_builder = local_var_req_builder
                .header("If-Modified-Since", local_var_param_value.to_string());
        }
        if let Some(ref local_var_token) = local_var_configuration.oauth_access_token {
            local_var_req_builder = local_var_req_builder.bearer_auth(local_var_token.to_owned());
        };
    ...
    async fn get_malware_entities(
        ...
        let GetMalwareEntitiesParams { ids } = params;
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::DomainMalwareResponse`"
                    ))));
                }
            }
        } else {
    ...
    async fn get_mitre_report(
        ...
        let GetMitreReportParams { actor_id, format } = params;
    ...
    async fn get_vulnerabilities(
        ...
        let GetVulnerabilitiesParams { body } = params;
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::DomainVulnerabilityResponse`"
                    ))));
                }
            }
        } else {
    ...
    async fn post_mitre_attacks(
        ...
        let PostMitreAttacksParams { body } = params;
    ...
    ) -> Result<models::DomainPublicIndicatorsV3Response, Error<QueryIntelIndicatorEntitiesError>>
    {
        ...
        if let Some(ref param_value) = include_deleted {
            local_var_req_builder =
                local_var_req_builder.query(&[("include_deleted", &param_value.to_string())]);
        }
        if let Some(ref param_value) = include_relations {
            local_var_req_builder =
                local_var_req_builder.query(&[("include_relations", &param_value.to_string())]);
        }
        if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
            local_var_req_builder = local_var_req_builder
                .header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    async fn query_intel_rule_ids(
        ...
        if let Some(ref param_value) = min_created_date {
            local_var_req_builder =
                local_var_req_builder.query(&[("min_created_date", &param_value.to_string())]);
        }
        if let Some(ref param_value) = max_created_date {
            local_var_req_builder =
                local_var_req_builder.query(&[("max_created_date", &param_value.to_string())]);
        }
        if let Some(ref param_value) = q {
            local_var_req_builder = local_var_req_builder.query(&[("q", &param_value.to_string())]);
        }
    ...
    async fn query_malware_entities(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<QueryMalwareEntitiesError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
    ...
    async fn query_mitre_attacks(
        ...
        let QueryMitreAttacksParams { id, ids } = params;
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::DomainQueryMitreAttacksResponse`"
                    ))));
                }
            }
        } else {
    ...
    async fn query_mitre_attacks_for_malware(
        ...
        let QueryMitreAttacksForMalwareParams { ids } = params;
