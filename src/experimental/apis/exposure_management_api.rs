...
pub trait ExposureManagementApi: Send + Sync {
    ...
    async fn aggregate_external_assets(
        &self,
        params: AggregateExternalAssetsParams,
    ...
    async fn blob_download_external_assets(
        &self,
        params: BlobDownloadExternalAssetsParams,
    ) -> Result<Vec<i32>, Error<BlobDownloadExternalAssetsError>>;

    /// GET /fem/entities/blobs-preview/v1
    ///
    /// Download a preview of the blob.
    async fn blob_preview_external_assets(
        &self,
        params: BlobPreviewExternalAssetsParams,
    ...
    ///
    ///
    async fn combined_ecosystem_subsidiaries(
        &self,
        params: CombinedEcosystemSubsidiariesParams,
    ) -> Result<
    ...
    ///
    ///
    async fn delete_external_assets(
        &self,
        params: DeleteExternalAssetsParams,
    ) -> Result<models::MsaspecQueryResponse, Error<DeleteExternalAssetsError>>;

    /// GET /fem/entities/ecosystem-subsidiaries/v1
    ///
    ///
    async fn get_ecosystem_subsidiaries(
        &self,
        params: GetEcosystemSubsidiariesParams,
    ) -> Result<
        models::DomainFemEcosystemSubsidiariesEntitiesResponse,
    ...
    ///
    ///
    async fn query_ecosystem_subsidiaries(
        &self,
        params: QueryEcosystemSubsidiariesParams,
    ) -> Result<
    ...
    ///
    ///
    async fn query_external_assets(
        &self,
        params: QueryExternalAssetsParams,
    ) -> Result<models::MsaspecQueryResponse, Error<QueryExternalAssetsError>>;

    /// GET /fem/queries/external-assets/v2
    ///
    ///
    async fn query_external_assets_v2(
        &self,
        params: QueryExternalAssetsV2Params,
...
impl ExposureManagementApi for ExposureManagementApiClient {
    ...
    async fn aggregate_external_assets(
        ...
        let AggregateExternalAssetsParams { body } = params;
    ...
    async fn blob_download_external_assets(
        ...
        let BlobDownloadExternalAssetsParams { asset_id, hash } = params;
    ...
    {
        let BlobPreviewExternalAssetsParams { asset_id, hash } = params;
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::DomainExternalAssetsBlobApiTypeV1`"
                    ))));
                }
            }
        } else {
    ...
    > {
        ...
        if let Some(ref param_value) = version_id {
            local_var_req_builder =
                local_var_req_builder.query(&[("version_id", &param_value.to_string())]);
        }
        if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
            local_var_req_builder = local_var_req_builder
                .header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::DomainFemEcosystemSubsidiariesEntitiesResponse`"
                    ))));
                }
            }
        } else {
    ...
    async fn delete_external_assets(
        ...
        let DeleteExternalAssetsParams { ids, body } = params;
    ...
    async fn get_ecosystem_subsidiaries(
        ...
        Error<GetEcosystemSubsidiariesError>,
    > {
        let GetEcosystemSubsidiariesParams { ids, version_id } = params;
    ...
    async fn get_external_assets(
        ...
        let GetExternalAssetsParams { ids } = params;
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::DomainExternalAssetsApiTypeV1`"
                    ))));
                }
            }
        } else {
    ...
    async fn patch_external_assets(
        ...
        let PatchExternalAssetsParams { body } = params;
    ...
    async fn post_external_assets_inventory_v1(
        ...
        Error<PostExternalAssetsInventoryV1Error>,
    > {
        let PostExternalAssetsInventoryV1Params { body } = params;
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::InventoryapiUserExternalAssetCreateResponseV1`"
                    ))));
                }
            }
        } else {
    ...
    > {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::DomainFemEcosystemSubsidiariesQueryResponse`"
                    ))));
                }
            }
        } else {
    ...
    async fn query_external_assets_v2(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::DomainDiscoverApiResponse`"
                    ))));
                }
            }
        } else {
            let local_var_entity: Option<QueryExternalAssetsV2Error> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
