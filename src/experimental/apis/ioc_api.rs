...
impl IocApi for IocApiClient {
    async fn action_get_v1(
        ...
        let ActionGetV1Params { ids } = params;
            ...
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::ApiActionRespV1`"
                    ))));
                }
            }
        } else {
    ...
    async fn action_query_v1(
        ...
        let ActionQueryV1Params { offset, limit } = params;
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::ApiIndicatorQueryRespV1`"
                    ))));
                }
            }
        } else {
    ...
    async fn get_indicators_report(
        ...
        let GetIndicatorsReportParams { body } = params;
    ...
    async fn indicator_aggregate_v1(
        ...
        if let Some(ref param_value) = from_parent {
            local_var_req_builder =
                local_var_req_builder.query(&[("from_parent", &param_value.to_string())]);
        }
        if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
            local_var_req_builder = local_var_req_builder
                .header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    async fn indicator_combined_v1(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::ApiIndicatorRespV1`"
                    ))));
                }
            }
        } else {
    ...
    async fn indicator_create_v1(
        ...
        if let Some(ref param_value) = retrodetects {
            local_var_req_builder =
                local_var_req_builder.query(&[("retrodetects", &param_value.to_string())]);
        }
        if let Some(ref param_value) = ignore_warnings {
            local_var_req_builder =
                local_var_req_builder.query(&[("ignore_warnings", &param_value.to_string())]);
        }
        if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
            local_var_req_builder = local_var_req_builder
                .header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    async fn indicator_get_device_count_v1(
        ...
        let IndicatorGetDeviceCountV1Params { r#type, value } = params;
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::ApiDeviceCountRespV1`"
                    ))));
                }
            }
        } else {
            let local_var_entity: Option<IndicatorGetDeviceCountV1Error> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
    ...
    async fn indicator_get_devices_ran_on_v1(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::ApiDevicesRanOnRespV1`"
                    ))));
                }
            }
        } else {
            let local_var_entity: Option<IndicatorGetDevicesRanOnV1Error> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
    ...
    async fn indicator_get_processes_ran_on_v1(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::ApiProcessesRanOnRespV1`"
                    ))));
                }
            }
        } else {
            let local_var_entity: Option<IndicatorGetProcessesRanOnV1Error> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
    ...
    async fn indicator_get_v1(
        ...
        let IndicatorGetV1Params { ids } = params;
    ...
    async fn ioc_type_query_v1(
        ...
        let IocTypeQueryV1Params { offset, limit } = params;
    ...
    async fn platform_query_v1(
        ...
        let PlatformQueryV1Params { offset, limit } = params;
    ...
    async fn severity_query_v1(
        ...
        let SeverityQueryV1Params { offset, limit } = params;
