...
pub trait CloudSecurityAssetsApi: Send + Sync {
    ...
    ///
    ///
    async fn cloud_security_assets_combined_application_findings(
        &self,
        params: CloudSecurityAssetsCombinedApplicationFindingsParams,
    ) -> Result<
        models::AssetsGetResourceApplicationFindingsResponse,
        Error<CloudSecurityAssetsCombinedApplicationFindingsError>,
    >;

    /// GET /cloud-security-assets/combined/compliance-controls/by-account-region-and-resource-type/v1
    ///
    ///
    async fn cloud_security_assets_combined_compliance_by_account(
        &self,
        params: CloudSecurityAssetsCombinedComplianceByAccountParams,
    ) -> Result<
    ...
    ///
    ///
    async fn cloud_security_assets_entities_get(
        &self,
        params: CloudSecurityAssetsEntitiesGetParams,
    ...
    ///
    ///
    async fn cloud_security_assets_queries(
        &self,
        params: CloudSecurityAssetsQueriesParams,
...
impl CloudSecurityAssetsApi for CloudSecurityAssetsApiClient {
    ...
    > {
        ...
        if let Some(ref param_value) = crn {
            local_var_req_builder =
                local_var_req_builder.query(&[("crn", &param_value.to_string())]);
        }
        if let Some(ref param_value) = gcrn {
            local_var_req_builder =
                local_var_req_builder.query(&[("gcrn", &param_value.to_string())]);
        }
            ...
            match local_var_content_type {
                ...
                ContentType::Text => {
                    return Err(Error::from(serde_json::Error::custom(
                        "Received `text/plain` content type response that cannot be converted to `models::AssetsGetResourceApplicationFindingsResponse`",
                    )));
                }
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::AssetsGetResourceApplicationFindingsResponse`"
                    ))));
                }
            }
        } else {
            let local_var_entity: Option<CloudSecurityAssetsCombinedApplicationFindingsError> =
    ...
    > {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::AssetsComplianceResponse`"
                    ))));
                }
            }
        } else {
    ...
    {
        let CloudSecurityAssetsEntitiesGetParams { ids } = params;
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::AssetsGetResourcesResponse`"
                    ))));
                }
            }
        } else {
    ...
    async fn cloud_security_assets_queries(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => {
                    return Err(Error::from(serde_json::Error::custom(format!(
                        "Received `{local_var_unknown_type}` content type response that cannot be converted to `models::AssetsGetResourceIdsResponse`"
                    ))));
                }
            }
        } else {
