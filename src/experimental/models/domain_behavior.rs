...
pub struct DomainBehavior {
    ...
    #[serde(rename = "alerts_details", skip_serializing_if = "Option::is_none")]
    pub alerts_details: Option<Vec<models::DomainAlertDetails>>,
    ...
    pub pattern_disposition_details: Option<models::PatterndispositionPatternDisposition>,
