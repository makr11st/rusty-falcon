...
pub struct ItautomationRunLiveQueryRequest {
    ...
    pub composite_query: Option<models::ItautomationCompositeQuery>,
    ...
    pub guardrails: Option<models::FalconforitapiGuardrails>,
    ...
    pub output_parser_config: Option<models::ItautomationOutputParserConfig>,
    #[serde(rename = "queries", skip_serializing_if = "Option::is_none")]
    pub queries: Option<models::ItautomationScripts>,
    #[serde(rename = "rows_parser_config", skip_serializing_if = "Option::is_none")]
    pub rows_parser_config: Option<models::ItautomationRowsParserConfig>,
}
