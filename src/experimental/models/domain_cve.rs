...
pub struct DomainCve {
    ...
    pub cisa_kev_info: models::DomainCisaKnownExploitedVulnerabilitiesInfo,
    #[serde(rename = "cps_rating")]
    pub cps_rating: models::DomainCpsRating,
    ...
    pub cvss_v2_score: Option<models::DomainCvssv2>,
    #[serde(rename = "cvss_v3_score", skip_serializing_if = "Option::is_none")]
    pub cvss_v3_score: Option<models::DomainCvssv3>,
    ...
    pub exploited: Option<models::DomainCveExploit>,
