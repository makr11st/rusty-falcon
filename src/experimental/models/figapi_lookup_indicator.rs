...
pub struct FigapiLookupIndicator {
    ...
    pub coin_address_details: Option<models::FigapiCoinAddress>,
    ...
    pub credentials_details: Option<models::FigapiCredentials>,
    #[serde(rename = "DomainDetails", skip_serializing_if = "Option::is_none")]
    pub domain_details: Option<models::FigapiDomain>,
    #[serde(
        rename = "EmailAddressDetails",
        skip_serializing_if = "Option::is_none"
    )]
    pub email_address_details: Option<models::FigapiEmailAddressDetails>,
    #[serde(rename = "FileDetails", skip_serializing_if = "Option::is_none")]
    pub file_details: Option<models::FigapiFile>,
    ...
    pub ipv4_details: Option<models::FigapiIpv4>,
    #[serde(rename = "IPv6Details", skip_serializing_if = "Option::is_none")]
    pub ipv6_details: Option<models::FigapiIpv6>,
    ...
    pub url_details: Option<models::FigapiUrl>,
    #[serde(
        rename = "UniqueIdentifierDetails",
        skip_serializing_if = "Option::is_none"
    )]
    pub unique_identifier_details: Option<models::FigapiUniqueIdentifier>,
    #[serde(rename = "Vulnerabilities", skip_serializing_if = "Option::is_none")]
    pub vulnerabilities: Option<Vec<models::FigapiVulnerability>>,
}

impl FigapiLookupIndicator {
    pub fn new() -> FigapiLookupIndicator {
        FigapiLookupIndicator {
            adversaries: None,
