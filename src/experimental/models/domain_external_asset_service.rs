...
pub struct DomainExternalAssetService {
    ...
    pub blob_links: Option<models::DomainExternalAssetServiceBlobsLinks>,
    ...
    pub http_attributes: Option<models::DomainExternalAssetHttpAttributes>,
    ...
    pub tls: Option<models::DomainExternalAssetSslRecord>,
}
