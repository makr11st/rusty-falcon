...
pub struct ResourcesCloudContext {
    ...
    pub asset_graph: Option<models::ResourcesAssetGraph>,
    #[serde(rename = "cloud_risks", skip_serializing_if = "Option::is_none")]
    pub cloud_risks: Option<models::ResourcesCloudRisks>,
    ...
    pub data_classifications: Option<models::DataclassificationsResponse>,
    #[serde(rename = "detections", skip_serializing_if = "Option::is_none")]
    pub detections: Option<models::ResourcesDetections>,
    ...
    pub host: Option<models::ResourcesHost>,
    #[serde(rename = "insights", skip_serializing_if = "Option::is_none")]
    pub insights: Option<models::InsightsInsight>,
    ...
    #[serde(rename = "open_cloud_risks", skip_serializing_if = "Option::is_none")]
    pub open_cloud_risks: Option<i32>,
