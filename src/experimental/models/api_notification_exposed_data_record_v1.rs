...
pub struct ApiNotificationExposedDataRecordV1 {
    ...
    #[serde(rename = "rule")]
    pub rule: models::ApiRuleDetailsV1,
    ...
    pub bot: Option<models::ApiExposedDataRecordBotV1>,
    ...
    pub file: Option<models::ApiExposedDataFileDetailsV1>,
    #[serde(rename = "financial", skip_serializing_if = "Option::is_none")]
    pub financial: Option<models::ApiExposedDataRecordFinancialV1>,
    ...
    pub location: Option<models::ApiExposedDataRecordLocationV1>,
    ...
    pub social: Option<models::ApiExposedDataRecordSocialV1>,
