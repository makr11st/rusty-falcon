...
pub struct DomainScheduledReportV1 {
    ...
    pub last_execution: Option<models::DomainReportExecutionSummaryV1>,
    ...
    pub report_metadata: Option<models::DomainReportMetadata>,
    #[serde(rename = "secret_references", skip_serializing_if = "Option::is_none")]
    pub secret_references: Option<models::DomainSecretReferencesV1>,
