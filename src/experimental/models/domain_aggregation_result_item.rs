...
pub struct DomainAggregationResultItem {
    ...
    pub sub_aggregates: Option<Vec<models::DomainAggregationResult>>,
...
impl DomainAggregationResultItem {
    pub fn new(count: i64) -> DomainAggregationResultItem {
        DomainAggregationResultItem {
            count,
            from: None,
            key_as_string: None,
            label: None,
