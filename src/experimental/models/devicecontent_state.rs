...
pub struct DevicecontentState {
    ...
    pub rapid_response_content: Option<models::DevicecontentContentCategory>,
    #[serde(
    ...
    pub sensor_operations: Option<models::DevicecontentContentCategory>,
    #[serde(rename = "system_critical", skip_serializing_if = "Option::is_none")]
    pub system_critical: Option<models::DevicecontentContentCategory>,
    #[serde(
        rename = "vulnerability_management",
        skip_serializing_if = "Option::is_none"
    )]
    pub vulnerability_management: Option<models::DevicecontentContentCategory>,
}
