...
pub struct DomainItemDetailsV1 {
    ...
    pub fragment_info: Option<models::DomainFragmentInfo>,
    ...
    pub iocs: Option<models::DomainIoc>,
    ...
    pub marketplace_product: Option<models::DomainMarketplaceProduct>,
    ...
    pub telegram_info: Option<models::DomainTelegramInfo>,
