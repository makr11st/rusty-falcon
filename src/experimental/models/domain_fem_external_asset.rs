...
pub struct DomainFemExternalAsset {
    ...
    pub discovery: Option<models::DomainExternalAssetDiscoveryAttributes>,
    #[serde(rename = "dns_domain", skip_serializing_if = "Option::is_none")]
    pub dns_domain: Option<models::DomainFemDnsDomain>,
    ...
    pub ip: Option<models::DomainFemExternalIp>,
    ...
    pub triage: Option<models::DomainExternalAssetsApiTriage>,
}
