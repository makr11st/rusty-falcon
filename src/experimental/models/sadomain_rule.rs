...
pub struct SadomainRule {
    ...
    #[serde(rename = "lookback_period", skip_serializing_if = "Option::is_none")]
    pub lookback_period: Option<i64>,
    ...
    pub ownership_assets: Option<models::SadomainCustomerAssets>,
