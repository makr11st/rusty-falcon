...
pub struct DomainScanV2 {
    ...
    #[serde(
        rename = "mac_cloud_ml_level_detection",
        skip_serializing_if = "Option::is_none"
    )]
    pub mac_cloud_ml_level_detection: Option<i32>,
    #[serde(
        rename = "mac_cloud_ml_level_prevention",
        skip_serializing_if = "Option::is_none"
    )]
    pub mac_cloud_ml_level_prevention: Option<i32>,
    #[serde(
        rename = "mac_cloud_pup_adware_level_detection",
        skip_serializing_if = "Option::is_none"
    )]
    pub mac_cloud_pup_adware_level_detection: Option<i32>,
    #[serde(
        rename = "mac_cloud_pup_adware_level_prevention",
        skip_serializing_if = "Option::is_none"
    )]
