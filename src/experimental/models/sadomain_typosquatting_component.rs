...
pub struct SadomainTyposquattingComponent {
    ...
    pub base_domain: models::SadomainTyposquattingBaseDomain,
    /// The ID of the infrastructure component
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "parent_domain")]
    pub parent_domain: models::SadomainTyposquattingParentDomain,
    ...
    pub subdomain: Option<models::SadomainTyposquattingSubdomain>,
    #[serde(
        rename = "submit_for_blocking_info",
        skip_serializing_if = "Option::is_none"
    )]
    pub submit_for_blocking_info: Option<models::SadomainSubmissionInformation>,
    #[serde(
        rename = "submit_for_takedown_info",
        skip_serializing_if = "Option::is_none"
    )]
    pub submit_for_takedown_info: Option<models::SadomainSubmissionInformation>,
}
