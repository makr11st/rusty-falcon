...
pub struct DomainEvent {
    ...
    pub botnet_config_source: Option<models::DomainBotnetConfigSource>,
    #[serde(rename = "ddos_attack_source", skip_serializing_if = "Option::is_none")]
    pub ddos_attack_source: Option<models::DomainDdosAttackSource>,
