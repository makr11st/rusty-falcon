...
pub struct ModelsSingleNodeExecutionCreateRequestV1 {
    ...
    pub definition: Option<models::ModelsDefinitionCreateRequestV2>,
}

impl ModelsSingleNodeExecutionCreateRequestV1 {
    pub fn new(mocks: String) -> ModelsSingleNodeExecutionCreateRequestV1 {
