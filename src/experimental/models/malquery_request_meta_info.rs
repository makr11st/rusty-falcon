...
pub struct MalqueryRequestMetaInfo {
    ...
    pub options: Option<models::MalqueryExternalHuntOptions>,
    #[serde(rename = "pagination", skip_serializing_if = "Option::is_none")]
    pub pagination: Option<models::MsaspecPaging>,
    ...
    pub stats: Option<models::MalqueryStats>,
    ...
    pub writes: Option<models::MsaspecWrites>,
