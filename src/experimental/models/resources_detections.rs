...
pub struct ResourcesDetections {
    ...
    pub compliant: Option<models::ResourcesCompliance>,
    ...
    pub ioa_counts_by_severity: Option<models::ResourcesDetectionCount>,
    #[serde(
        rename = "iom_counts_by_severity",
        skip_serializing_if = "Option::is_none"
    )]
    pub iom_counts_by_severity: Option<models::ResourcesDetectionCount>,
    #[serde(rename = "non_compliant", skip_serializing_if = "Option::is_none")]
    pub non_compliant: Option<models::ResourcesCompliance>,
