...
use crate::apis::{Api, ApiClient, configuration::Configuration, oauth2_api::{Oauth2AccessTokenParams, Oauth2Api, Oauth2ApiClient}};
...
impl FalconClientBuilder {
    ...
    pub async fn build(self) -> Result<FalconClient, FalconError> {
        let credentials = self
            .credentials
            .ok_or(FalconError::MissingClientId)?;
