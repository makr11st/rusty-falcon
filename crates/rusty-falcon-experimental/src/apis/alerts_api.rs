...
pub trait AlertsApi: Send + Sync {
    ...
    ///
    /// 
    async fn get_queries_alerts_v1(&self,  params: GetQueriesAlertsV1Params ) -> Result<models::DetectsapiAlertQueryResponse, Error<GetQueriesAlertsV1Error>>;

    /// GET /alerts/queries/alerts/v2
    ///
    /// 
    async fn get_queries_alerts_v2(&self,  params: GetQueriesAlertsV2Params ) -> Result<models::DetectsapiAlertQueryResponse, Error<GetQueriesAlertsV2Error>>;

    /// PATCH /alerts/entities/alerts/v2
    ///
    /// 
    async fn patch_entities_alerts_v2(&self,  params: PatchEntitiesAlertsV2Params ) -> Result<models::DetectsapiResponseFields, Error<PatchEntitiesAlertsV2Error>>;

    /// PATCH /alerts/entities/alerts/v3
    ///
    /// 
    async fn patch_entities_alerts_v3(&self,  params: PatchEntitiesAlertsV3Params ) -> Result<models::DetectsapiResponseFields, Error<PatchEntitiesAlertsV3Error>>;

    /// POST /alerts/aggregates/alerts/v1
    ///
    /// 
    async fn post_aggregates_alerts_v1(&self,  params: PostAggregatesAlertsV1Params ) -> Result<models::DetectsapiAggregatesResponse, Error<PostAggregatesAlertsV1Error>>;

    /// POST /alerts/aggregates/alerts/v2
    ///
    /// 
    async fn post_aggregates_alerts_v2(&self,  params: PostAggregatesAlertsV2Params ) -> Result<models::DetectsapiAggregatesResponse, Error<PostAggregatesAlertsV2Error>>;

    /// POST /alerts/combined/alerts/v1
    ///
    /// 
    async fn post_combined_alerts_v1(&self,  params: PostCombinedAlertsV1Params ) -> Result<models::DetectsapiPostCombinedAlertsV1ResponseSwagger, Error<PostCombinedAlertsV1Error>>;

    /// POST /alerts/entities/alerts/v1
    ///
    /// 
    async fn post_entities_alerts_v1(&self,  params: PostEntitiesAlertsV1Params ) -> Result<models::DetectsapiPostEntitiesAlertsV1ResponseSwagger, Error<PostEntitiesAlertsV1Error>>;

    /// POST /alerts/entities/alerts/v2
    ///
    /// 
    async fn post_entities_alerts_v2(&self,  params: PostEntitiesAlertsV2Params ) -> Result<models::DetectsapiPostEntitiesAlertsV2ResponseSwagger, Error<PostEntitiesAlertsV2Error>>;
}
...
impl AlertsApi for AlertsApiClient {
    async fn get_queries_alerts_v1(&self,  params: GetQueriesAlertsV1Params ) -> Result<models::DetectsapiAlertQueryResponse, Error<GetQueriesAlertsV1Error>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::DetectsapiAlertQueryResponse`")))),
            }
        } else {
    ...
    async fn get_queries_alerts_v2(&self,  params: GetQueriesAlertsV2Params ) -> Result<models::DetectsapiAlertQueryResponse, Error<GetQueriesAlertsV2Error>> {
        ...
        let local_var_uri_str = format!("{}/alerts/queries/alerts/v2", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());

        if let Some(ref param_value) = include_hidden {
            local_var_req_builder = local_var_req_builder.query(&[("include_hidden", &param_value.to_string())]);
        }
        if let Some(ref param_value) = offset {
            local_var_req_builder = local_var_req_builder.query(&[("offset", &param_value.to_string())]);
        }
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetQueriesAlertsV2Error> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn patch_entities_alerts_v2(&self,  params: PatchEntitiesAlertsV2Params ) -> Result<models::DetectsapiResponseFields, Error<PatchEntitiesAlertsV2Error>> {
        ...
        let PatchEntitiesAlertsV2Params {
            body,
        } = params;
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::DetectsapiResponseFields`")))),
            }
        } else {
    ...
    async fn patch_entities_alerts_v3(&self,  params: PatchEntitiesAlertsV3Params ) -> Result<models::DetectsapiResponseFields, Error<PatchEntitiesAlertsV3Error>> {
        ...
        let local_var_uri_str = format!("{}/alerts/entities/alerts/v3", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::PATCH, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<PatchEntitiesAlertsV3Error> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn post_aggregates_alerts_v1(&self,  params: PostAggregatesAlertsV1Params ) -> Result<models::DetectsapiAggregatesResponse, Error<PostAggregatesAlertsV1Error>> {
        ...
        let PostAggregatesAlertsV1Params {
            body,
        } = params;
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::DetectsapiAggregatesResponse`")))),
            }
        } else {
    ...
    async fn post_aggregates_alerts_v2(&self,  params: PostAggregatesAlertsV2Params ) -> Result<models::DetectsapiAggregatesResponse, Error<PostAggregatesAlertsV2Error>> {
        ...
        let local_var_uri_str = format!("{}/alerts/aggregates/alerts/v2", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<PostAggregatesAlertsV2Error> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn post_combined_alerts_v1(&self,  params: PostCombinedAlertsV1Params ) -> Result<models::DetectsapiPostCombinedAlertsV1ResponseSwagger, Error<PostCombinedAlertsV1Error>> {
        ...
        let PostCombinedAlertsV1Params {
            body,
        } = params;
        ...
        let local_var_uri_str = format!("{}/alerts/combined/alerts/v1", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::DetectsapiPostCombinedAlertsV1ResponseSwagger`")))),
            }
        } else {
            let local_var_entity: Option<PostCombinedAlertsV1Error> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn post_entities_alerts_v1(&self,  params: PostEntitiesAlertsV1Params ) -> Result<models::DetectsapiPostEntitiesAlertsV1ResponseSwagger, Error<PostEntitiesAlertsV1Error>> {
        ...
        let PostEntitiesAlertsV1Params {
            body,
        } = params;
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::DetectsapiPostEntitiesAlertsV1ResponseSwagger`")))),
            }
        } else {
    ...
    async fn post_entities_alerts_v2(&self,  params: PostEntitiesAlertsV2Params ) -> Result<models::DetectsapiPostEntitiesAlertsV2ResponseSwagger, Error<PostEntitiesAlertsV2Error>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::DetectsapiPostEntitiesAlertsV2ResponseSwagger`")))),
            }
        } else {
            let local_var_entity: Option<PostEntitiesAlertsV2Error> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
