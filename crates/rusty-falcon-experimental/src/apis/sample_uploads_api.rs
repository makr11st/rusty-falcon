...
pub trait SampleUploadsApi: Send + Sync {
    ...
    ///
    /// 
    async fn archive_delete_v1(&self,  params: ArchiveDeleteV1Params ) -> Result<(), Error<ArchiveDeleteV1Error>>;

    /// GET /archives/entities/archives/v1
    ///
    /// 
    async fn archive_get_v1(&self,  params: ArchiveGetV1Params ) -> Result<models::ClientArchiveCreateResponseV1, Error<ArchiveGetV1Error>>;

    /// GET /archives/entities/archive-files/v1
    ///
    /// 
    async fn archive_list_v1(&self,  params: ArchiveListV1Params ) -> Result<models::ClientArchiveListFilesResponseV1, Error<ArchiveListV1Error>>;

    /// POST /archives/entities/archives/v1
    ///
    /// 
    async fn archive_upload_v1(&self,  params: ArchiveUploadV1Params ) -> Result<models::ClientArchiveCreateResponseV1, Error<ArchiveUploadV1Error>>;

    /// POST /archives/entities/archives/v2
    ///
    /// 
    async fn archive_upload_v2(&self,  params: ArchiveUploadV2Params ) -> Result<models::ClientArchiveCreateResponseV1, Error<ArchiveUploadV2Error>>;

    /// DELETE /samples/entities/samples/v3
    ///
    /// 
    async fn delete_sample_v3(&self,  params: DeleteSampleV3Params ) -> Result<models::MsaQueryResponse, Error<DeleteSampleV3Error>>;

    /// POST /archives/entities/extractions/v1
    ///
    /// 
    async fn extraction_create_v1(&self,  params: ExtractionCreateV1Params ) -> Result<models::ClientExtractionCreateResponseV1, Error<ExtractionCreateV1Error>>;

    /// GET /archives/entities/extractions/v1
    ///
    /// 
    async fn extraction_get_v1(&self,  params: ExtractionGetV1Params ) -> Result<models::ClientExtractionCreateResponseV1, Error<ExtractionGetV1Error>>;

    /// GET /archives/entities/extraction-files/v1
    ///
    /// 
    async fn extraction_list_v1(&self,  params: ExtractionListV1Params ) -> Result<models::ClientExtractionListFilesResponseV1, Error<ExtractionListV1Error>>;

    /// GET /samples/entities/samples/v3
    ///
    /// 
    async fn get_sample_v3(&self,  params: GetSampleV3Params ) -> Result<String, Error<GetSampleV3Error>>;

    /// POST /samples/entities/samples/v3
    ///
    /// 
    async fn upload_sample_v3(&self,  params: UploadSampleV3Params ) -> Result<models::ClientSampleMetadataResponseV2, Error<UploadSampleV3Error>>;
}
...
impl SampleUploadsApi for SampleUploadsApiClient {
    ...
    async fn archive_get_v1(&self,  params: ArchiveGetV1Params ) -> Result<models::ClientArchiveCreateResponseV1, Error<ArchiveGetV1Error>> {
        ...
        if let Some(ref param_value) = include_files {
            local_var_req_builder = local_var_req_builder.query(&[("include_files", &param_value.to_string())]);
        }
        if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
            local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
        }
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::ClientArchiveCreateResponseV1`")))),
            }
        } else {
    ...
    async fn archive_list_v1(&self,  params: ArchiveListV1Params ) -> Result<models::ClientArchiveListFilesResponseV1, Error<ArchiveListV1Error>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::ClientArchiveListFilesResponseV1`")))),
            }
        } else {
    ...
    async fn archive_upload_v1(&self,  params: ArchiveUploadV1Params ) -> Result<models::ClientArchiveCreateResponseV1, Error<ArchiveUploadV1Error>> {
        ...
        if let Some(ref param_value) = password {
            local_var_req_builder = local_var_req_builder.query(&[("password", &param_value.to_string())]);
        }
        if let Some(ref param_value) = is_confidential {
            local_var_req_builder = local_var_req_builder.query(&[("is_confidential", &param_value.to_string())]);
        }
    ...
    async fn extraction_create_v1(&self,  params: ExtractionCreateV1Params ) -> Result<models::ClientExtractionCreateResponseV1, Error<ExtractionCreateV1Error>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::ClientExtractionCreateResponseV1`")))),
            }
        } else {
    ...
    async fn extraction_list_v1(&self,  params: ExtractionListV1Params ) -> Result<models::ClientExtractionListFilesResponseV1, Error<ExtractionListV1Error>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::ClientExtractionListFilesResponseV1`")))),
            }
        } else {
