...
pub trait FalconxSandboxApi: Send + Sync {
    ...
    ///
    /// 
    async fn delete_report(&self,  params: DeleteReportParams ) -> Result<models::FalconxQueryResponse, Error<DeleteReportError>>;

    /// DELETE /samples/entities/samples/v2
    ///
    /// 
    async fn delete_sample_v2(&self,  params: DeleteSampleV2Params ) -> Result<models::MsaQueryResponse, Error<DeleteSampleV2Error>>;

    /// GET /falconx/entities/artifacts/v1
    ///
    /// 
    async fn get_artifacts(&self,  params: GetArtifactsParams ) -> Result<models::MsaspecQueryResponse, Error<GetArtifactsError>>;

    /// GET /falconx/entities/memory-dump/v1
    ///
    /// 
    async fn get_memory_dump(&self,  params: GetMemoryDumpParams ) -> Result<models::MsaspecQueryResponse, Error<GetMemoryDumpError>>;

    /// GET /falconx/entities/memory-dump/extracted-strings/v1
    ///
    /// 
    async fn get_memory_dump_extracted_strings(&self,  params: GetMemoryDumpExtractedStringsParams ) -> Result<models::MsaspecQueryResponse, Error<GetMemoryDumpExtractedStringsError>>;

    /// GET /falconx/entities/memory-dump/hex-dump/v1
    ///
    /// 
    async fn get_memory_dump_hex_dump(&self,  params: GetMemoryDumpHexDumpParams ) -> Result<models::MsaspecQueryResponse, Error<GetMemoryDumpHexDumpError>>;

    /// GET /falconx/entities/reports/v1
    ///
    /// 
    async fn get_reports(&self,  params: GetReportsParams ) -> Result<models::FalconxReportV1Response, Error<GetReportsError>>;

    /// GET /samples/entities/samples/v2
    ///
    /// 
    async fn get_sample_v2(&self,  params: GetSampleV2Params ) -> Result<String, Error<GetSampleV2Error>>;

    /// GET /falconx/entities/submissions/v1
    ///
    /// 
    async fn get_submissions(&self,  params: GetSubmissionsParams ) -> Result<models::FalconxSubmissionV1Response, Error<GetSubmissionsError>>;

    /// GET /falconx/entities/report-summaries/v1
    ///
    /// 
    async fn get_summary_reports(&self,  params: GetSummaryReportsParams ) -> Result<models::FalconxSummaryReportV1Response, Error<GetSummaryReportsError>>;

    /// GET /falconx/queries/reports/v1
    ///
    /// 
    async fn query_reports(&self,  params: QueryReportsParams ) -> Result<models::MsaspecQueryResponse, Error<QueryReportsError>>;

    /// POST /samples/queries/samples/GET/v1
    ///
    /// 
    async fn query_sample_v1(&self,  params: QuerySampleV1Params ) -> Result<models::MsaQueryResponse, Error<QuerySampleV1Error>>;

    /// GET /falconx/queries/submissions/v1
    ///
    /// 
    async fn query_submissions(&self,  params: QuerySubmissionsParams ) -> Result<models::MsaspecQueryResponse, Error<QuerySubmissionsError>>;

    /// POST /falconx/entities/submissions/v1
    ///
    /// 
    async fn submit(&self,  params: SubmitParams ) -> Result<models::FalconxSubmissionV1Response, Error<SubmitError>>;

    /// POST /samples/entities/samples/v2
    ///
    /// 
    async fn upload_sample_v2(&self,  params: UploadSampleV2Params ) -> Result<models::ClientSampleMetadataResponseV2, Error<UploadSampleV2Error>>;
}
...
impl FalconxSandboxApi for FalconxSandboxApiClient {
    async fn delete_report(&self,  params: DeleteReportParams ) -> Result<models::FalconxQueryResponse, Error<DeleteReportError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::FalconxQueryResponse`")))),
            }
        } else {
    ...
    async fn get_memory_dump(&self,  params: GetMemoryDumpParams ) -> Result<models::MsaspecQueryResponse, Error<GetMemoryDumpError>> {
        ...
        let local_var_uri_str = format!("{}/falconx/entities/memory-dump/v1", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetMemoryDumpError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_memory_dump_extracted_strings(&self,  params: GetMemoryDumpExtractedStringsParams ) -> Result<models::MsaspecQueryResponse, Error<GetMemoryDumpExtractedStringsError>> {
        ...
        let local_var_uri_str = format!("{}/falconx/entities/memory-dump/extracted-strings/v1", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetMemoryDumpExtractedStringsError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_memory_dump_hex_dump(&self,  params: GetMemoryDumpHexDumpParams ) -> Result<models::MsaspecQueryResponse, Error<GetMemoryDumpHexDumpError>> {
        ...
        let local_var_uri_str = format!("{}/falconx/entities/memory-dump/hex-dump/v1", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetMemoryDumpHexDumpError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_reports(&self,  params: GetReportsParams ) -> Result<models::FalconxReportV1Response, Error<GetReportsError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::FalconxReportV1Response`")))),
            }
        } else {
    ...
    async fn get_submissions(&self,  params: GetSubmissionsParams ) -> Result<models::FalconxSubmissionV1Response, Error<GetSubmissionsError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::FalconxSubmissionV1Response`")))),
            }
        } else {
    ...
    async fn get_summary_reports(&self,  params: GetSummaryReportsParams ) -> Result<models::FalconxSummaryReportV1Response, Error<GetSummaryReportsError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::FalconxSummaryReportV1Response`")))),
            }
        } else {
    ...
    async fn submit(&self,  params: SubmitParams ) -> Result<models::FalconxSubmissionV1Response, Error<SubmitError>> {
        ...
        if let Some(ref param_value) = aid {
            local_var_req_builder = local_var_req_builder.query(&[("aid", &param_value.to_string())]);
        }
        if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
            local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
        }
    ...
    async fn upload_sample_v2(&self,  params: UploadSampleV2Params ) -> Result<models::ClientSampleMetadataResponseV2, Error<UploadSampleV2Error>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::ClientSampleMetadataResponseV2`")))),
            }
        } else {
