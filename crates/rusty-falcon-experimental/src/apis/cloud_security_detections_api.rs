...
pub trait CloudSecurityDetectionsApi: Send + Sync {
    ...
    ///
    /// 
    async fn cspm_evaluations_iom_entities(&self,  params: CspmEvaluationsIomEntitiesParams ) -> Result<models::EvaluationsGetIomsResponse, Error<CspmEvaluationsIomEntitiesError>>;

    /// GET /cloud-security-evaluations/queries/ioms/v1
    ///
    /// 
    async fn cspm_evaluations_iom_queries(&self,  params: CspmEvaluationsIomQueriesParams ) -> Result<models::EvaluationsQueryIomsResponse, Error<CspmEvaluationsIomQueriesError>>;
}
...
impl CloudSecurityDetectionsApi for CloudSecurityDetectionsApiClient {
    async fn cspm_evaluations_iom_entities(&self,  params: CspmEvaluationsIomEntitiesParams ) -> Result<models::EvaluationsGetIomsResponse, Error<CspmEvaluationsIomEntitiesError>> {
        ...
        let CspmEvaluationsIomEntitiesParams {
            ids,
        } = params;
        ...
        let local_var_uri_str = format!("{}/cloud-security-evaluations/entities/ioms/v1", local_var_configuration.base_path);
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::EvaluationsGetIomsResponse`")))),
            }
        } else {
            let local_var_entity: Option<CspmEvaluationsIomEntitiesError> = serde_json::from_str(&local_var_content).ok();
    ...
    async fn cspm_evaluations_iom_queries(&self,  params: CspmEvaluationsIomQueriesParams ) -> Result<models::EvaluationsQueryIomsResponse, Error<CspmEvaluationsIomQueriesError>> {
        ...
        let local_var_uri_str = format!("{}/cloud-security-evaluations/queries/ioms/v1", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::EvaluationsQueryIomsResponse`")))),
            }
        } else {
            let local_var_entity: Option<CspmEvaluationsIomQueriesError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
