...
pub trait EventStreamsApi: Send + Sync {
    ...
    ///
    /// 
    async fn list_available_streams_o_auth2(&self,  params: ListAvailableStreamsOAuth2Params ) -> Result<models::MainDiscoveryResponseV2, Error<ListAvailableStreamsOAuth2Error>>;

    /// POST /sensors/entities/datafeed-actions/v1/{partition}
    ///
    /// 
    async fn refresh_active_stream_session(&self,  params: RefreshActiveStreamSessionParams ) -> Result<models::MsaReplyMetaOnly, Error<RefreshActiveStreamSessionError>>;
}
...
impl EventStreamsApi for EventStreamsApiClient {
    async fn list_available_streams_o_auth2(&self,  params: ListAvailableStreamsOAuth2Params ) -> Result<models::MainDiscoveryResponseV2, Error<ListAvailableStreamsOAuth2Error>> {
        ...
        let ListAvailableStreamsOAuth2Params {
            app_id,
            format,
        } = params;
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::MainDiscoveryResponseV2`")))),
            }
        } else {
