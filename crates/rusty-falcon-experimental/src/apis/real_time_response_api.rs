...
pub trait RealTimeResponseApi: Send + Sync {
    ...
    ///
    /// 
    async fn batch_active_responder_cmd(&self,  params: BatchActiveResponderCmdParams ) -> Result<models::DomainMultiCommandExecuteResponseWrapper, Error<BatchActiveResponderCmdError>>;

    /// POST /real-time-response/combined/batch-command/v1
    ///
    /// 
    async fn batch_cmd(&self,  params: BatchCmdParams ) -> Result<models::DomainMultiCommandExecuteResponseWrapper, Error<BatchCmdError>>;

    /// POST /real-time-response/combined/batch-get-command/v1
    ///
    /// 
    async fn batch_get_cmd(&self,  params: BatchGetCmdParams ) -> Result<models::DomainBatchGetCommandResponse, Error<BatchGetCmdError>>;

    /// GET /real-time-response/combined/batch-get-command/v1
    ///
    /// 
    async fn batch_get_cmd_status(&self,  params: BatchGetCmdStatusParams ) -> Result<models::DomainBatchGetCmdStatusResponse, Error<BatchGetCmdStatusError>>;

    /// POST /real-time-response/combined/batch-init-session/v1
    ///
    /// 
    async fn batch_init_sessions(&self,  params: BatchInitSessionsParams ) -> Result<models::DomainBatchInitSessionResponse, Error<BatchInitSessionsError>>;

    /// POST /real-time-response/combined/batch-refresh-session/v1
    ///
    /// 
    async fn batch_refresh_sessions(&self,  params: BatchRefreshSessionsParams ) -> Result<models::DomainBatchRefreshSessionResponse, Error<BatchRefreshSessionsError>>;

    /// POST /real-time-response/aggregates/sessions/GET/v1
    ///
    /// 
    async fn r_tr_aggregate_sessions(&self,  params: RTrAggregateSessionsParams ) -> Result<models::MsaAggregatesResponse, Error<RTrAggregateSessionsError>>;

    /// GET /real-time-response/entities/active-responder-command/v1
    ///
    /// 
    async fn r_tr_check_active_responder_command_status(&self,  params: RTrCheckActiveResponderCommandStatusParams ) -> Result<models::DomainStatusResponseWrapper, Error<RTrCheckActiveResponderCommandStatusError>>;

    /// GET /real-time-response/entities/command/v1
    ///
    /// 
    async fn r_tr_check_command_status(&self,  params: RTrCheckCommandStatusParams ) -> Result<models::DomainStatusResponseWrapper, Error<RTrCheckCommandStatusError>>;

    /// DELETE /real-time-response/entities/file/v1
    ///
    /// 
    async fn r_tr_delete_file(&self,  params: RTrDeleteFileParams ) -> Result<models::MsaReplyMetaOnly, Error<RTrDeleteFileError>>;

    /// DELETE /real-time-response/entities/file/v2
    ///
    /// 
    async fn r_tr_delete_file_v2(&self,  params: RTrDeleteFileV2Params ) -> Result<models::MsaReplyMetaOnly, Error<RTrDeleteFileV2Error>>;

    /// DELETE /real-time-response/entities/queued-sessions/command/v1
    ///
    /// 
    async fn r_tr_delete_queued_session(&self,  params: RTrDeleteQueuedSessionParams ) -> Result<models::MsaspecQueryResponse, Error<RTrDeleteQueuedSessionError>>;

    /// DELETE /real-time-response/entities/sessions/v1
    ///
    /// 
    async fn r_tr_delete_session(&self,  params: RTrDeleteSessionParams ) -> Result<models::MsaReplyMetaOnly, Error<RTrDeleteSessionError>>;

    /// POST /real-time-response/entities/active-responder-command/v1
    ///
    /// 
    async fn r_tr_execute_active_responder_command(&self,  params: RTrExecuteActiveResponderCommandParams ) -> Result<models::DomainCommandExecuteResponseWrapper, Error<RTrExecuteActiveResponderCommandError>>;

    /// POST /real-time-response/entities/command/v1
    ///
    /// 
    async fn r_tr_execute_command(&self,  params: RTrExecuteCommandParams ) -> Result<models::DomainCommandExecuteResponseWrapper, Error<RTrExecuteCommandError>>;

    /// GET /real-time-response/entities/extracted-file-contents/v1
    ///
    /// 
    async fn r_tr_get_extracted_file_contents(&self,  params: RTrGetExtractedFileContentsParams ) -> Result<Vec<i32>, Error<RTrGetExtractedFileContentsError>>;

    /// POST /real-time-response/entities/sessions/v1
    ///
    /// 
    async fn r_tr_init_session(&self,  params: RTrInitSessionParams ) -> Result<models::DomainInitResponseWrapper, Error<RTrInitSessionError>>;

    /// GET /real-time-response/queries/sessions/v1
    ///
    /// 
    async fn r_tr_list_all_sessions(&self,  params: RTrListAllSessionsParams ) -> Result<models::DomainListSessionsResponseMsa, Error<RTrListAllSessionsError>>;

    /// GET /real-time-response/entities/file/v1
    ///
    /// 
    async fn r_tr_list_files(&self,  params: RTrListFilesParams ) -> Result<models::DomainListFilesResponseWrapper, Error<RTrListFilesError>>;

    /// GET /real-time-response/entities/file/v2
    ///
    /// 
    async fn r_tr_list_files_v2(&self,  params: RTrListFilesV2Params ) -> Result<models::DomainListFilesV2ResponseWrapper, Error<RTrListFilesV2Error>>;

    /// POST /real-time-response/entities/queued-sessions/GET/v1
    ///
    /// 
    async fn r_tr_list_queued_sessions(&self,  params: RTrListQueuedSessionsParams ) -> Result<models::DomainQueuedSessionResponseWrapper, Error<RTrListQueuedSessionsError>>;

    /// POST /real-time-response/entities/sessions/GET/v1
    ///
    /// 
    async fn r_tr_list_sessions(&self,  params: RTrListSessionsParams ) -> Result<models::DomainSessionResponseWrapper, Error<RTrListSessionsError>>;

    /// POST /real-time-response/entities/refresh-session/v1
    ///
    /// 
    async fn r_tr_pulse_session(&self,  params: RTrPulseSessionParams ) -> Result<models::DomainInitResponseWrapper, Error<RTrPulseSessionError>>;
}
...
impl RealTimeResponseApi for RealTimeResponseApiClient {
    ...
    async fn batch_get_cmd(&self,  params: BatchGetCmdParams ) -> Result<models::DomainBatchGetCommandResponse, Error<BatchGetCmdError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::DomainBatchGetCommandResponse`")))),
            }
        } else {
    ...
    async fn batch_get_cmd_status(&self,  params: BatchGetCmdStatusParams ) -> Result<models::DomainBatchGetCmdStatusResponse, Error<BatchGetCmdStatusError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::DomainBatchGetCmdStatusResponse`")))),
            }
        } else {
    ...
    async fn batch_init_sessions(&self,  params: BatchInitSessionsParams ) -> Result<models::DomainBatchInitSessionResponse, Error<BatchInitSessionsError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::DomainBatchInitSessionResponse`")))),
            }
        } else {
    ...
    async fn batch_refresh_sessions(&self,  params: BatchRefreshSessionsParams ) -> Result<models::DomainBatchRefreshSessionResponse, Error<BatchRefreshSessionsError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::DomainBatchRefreshSessionResponse`")))),
            }
        } else {
    ...
    async fn r_tr_aggregate_sessions(&self,  params: RTrAggregateSessionsParams ) -> Result<models::MsaAggregatesResponse, Error<RTrAggregateSessionsError>> {
        ...
        let RTrAggregateSessionsParams {
            body,
        } = params;
    ...
    async fn r_tr_execute_active_responder_command(&self,  params: RTrExecuteActiveResponderCommandParams ) -> Result<models::DomainCommandExecuteResponseWrapper, Error<RTrExecuteActiveResponderCommandError>> {
        ...
        let RTrExecuteActiveResponderCommandParams {
            body,
        } = params;
    ...
    async fn r_tr_init_session(&self,  params: RTrInitSessionParams ) -> Result<models::DomainInitResponseWrapper, Error<RTrInitSessionError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::DomainInitResponseWrapper`")))),
            }
        } else {
    ...
    async fn r_tr_list_all_sessions(&self,  params: RTrListAllSessionsParams ) -> Result<models::DomainListSessionsResponseMsa, Error<RTrListAllSessionsError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::DomainListSessionsResponseMsa`")))),
            }
        } else {
    ...
    async fn r_tr_list_files(&self,  params: RTrListFilesParams ) -> Result<models::DomainListFilesResponseWrapper, Error<RTrListFilesError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::DomainListFilesResponseWrapper`")))),
            }
        } else {
    ...
    async fn r_tr_list_files_v2(&self,  params: RTrListFilesV2Params ) -> Result<models::DomainListFilesV2ResponseWrapper, Error<RTrListFilesV2Error>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::DomainListFilesV2ResponseWrapper`")))),
            }
        } else {
    ...
    async fn r_tr_list_queued_sessions(&self,  params: RTrListQueuedSessionsParams ) -> Result<models::DomainQueuedSessionResponseWrapper, Error<RTrListQueuedSessionsError>> {
        ...
        let RTrListQueuedSessionsParams {
            body,
        } = params;
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::DomainQueuedSessionResponseWrapper`")))),
            }
        } else {
    ...
    async fn r_tr_list_sessions(&self,  params: RTrListSessionsParams ) -> Result<models::DomainSessionResponseWrapper, Error<RTrListSessionsError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::DomainSessionResponseWrapper`")))),
            }
        } else {
