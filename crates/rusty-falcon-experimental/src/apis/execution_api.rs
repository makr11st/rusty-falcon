...
pub trait ExecutionApi: Send + Sync {
    ...
    ///
    /// 
    async fn read_request_body(&self,  params: ReadRequestBodyParams ) -> Result<serde_json::Value, Error<ReadRequestBodyError>>;
}
...
/// struct for passing parameters to the method [`ExecutionApi::read_request_body`]
#[derive(Clone, Debug)]
#[cfg_attr(feature = "bon", derive(::bon::Builder))]
pub struct ReadRequestBodyParams {
    /// Execution ID
    pub id: String,
...
impl ExecutionApi for ExecutionApiClient {
    async fn read_request_body(&self,  params: ReadRequestBodyParams ) -> Result<serde_json::Value, Error<ReadRequestBodyError>> {
        ...
        let local_var_uri_str = format!("{}/faas-gateway/entities/execution-request-body/v2", local_var_configuration.base_path);
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<ReadRequestBodyError> = serde_json::from_str(&local_var_content).ok();
...
/// struct for typed errors of method [`ExecutionApi::read_request_body`]
