...
pub trait QuickScanApi: Send + Sync {
    ...
    ///
    /// 
    async fn get_scans(&self,  params: GetScansParams ) -> Result<models::MlscannerapiScanV1Response, Error<GetScansError>>;

    /// POST /scanner/aggregates/scans/GET/v1
    ///
    /// 
    async fn get_scans_aggregates(&self,  params: GetScansAggregatesParams ) -> Result<(), Error<GetScansAggregatesError>>;

    /// GET /scanner/queries/scans/v1
    ///
    /// 
    async fn query_submissions_mixin0(&self,  params: QuerySubmissionsMixin0Params ) -> Result<models::MlscannerapiQueryResponse, Error<QuerySubmissionsMixin0Error>>;

    /// POST /scanner/entities/scans/v1
    ///
    /// 
    async fn scan_samples(&self,  params: ScanSamplesParams ) -> Result<models::MlscannerapiQueryResponse, Error<ScanSamplesError>>;
}
    ...
    async fn get_scans(&self,  params: GetScansParams ) -> Result<models::MlscannerapiScanV1Response, Error<GetScansError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::MlscannerapiScanV1Response`")))),
            }
        } else {
    ...
    async fn query_submissions_mixin0(&self,  params: QuerySubmissionsMixin0Params ) -> Result<models::MlscannerapiQueryResponse, Error<QuerySubmissionsMixin0Error>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::MlscannerapiQueryResponse`")))),
            }
        } else {
