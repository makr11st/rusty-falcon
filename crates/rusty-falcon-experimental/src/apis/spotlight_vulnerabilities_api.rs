...
pub trait SpotlightVulnerabilitiesApi: Send + Sync {
    ...
    ///
    /// 
    async fn combined_query_vulnerabilities(&self,  params: CombinedQueryVulnerabilitiesParams ) -> Result<models::DomainSpapiCombinedVulnerabilitiesResponse, Error<CombinedQueryVulnerabilitiesError>>;

    /// GET /spotlight/entities/remediations/v2
    ///
    /// 
    async fn get_remediations_v2(&self,  params: GetRemediationsV2Params ) -> Result<models::DomainSpapiRemediationEntitiesResponseV2, Error<GetRemediationsV2Error>>;

    /// GET /spotlight/entities/vulnerabilities/v2
    ///
    /// 
    async fn get_vulnerabilities(&self,  params: GetVulnerabilitiesParams ) -> Result<models::DomainSpapiVulnerabilitiesEntitiesResponseV2, Error<GetVulnerabilitiesError>>;

    /// GET /spotlight/queries/vulnerabilities/v1
    ///
    /// 
    async fn query_vulnerabilities(&self,  params: QueryVulnerabilitiesParams ) -> Result<models::DomainSpapiQueryResponse, Error<QueryVulnerabilitiesError>>;
}
    ...
    async fn combined_query_vulnerabilities(&self,  params: CombinedQueryVulnerabilitiesParams ) -> Result<models::DomainSpapiCombinedVulnerabilitiesResponse, Error<CombinedQueryVulnerabilitiesError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::DomainSpapiCombinedVulnerabilitiesResponse`")))),
            }
        } else {
    ...
    async fn get_remediations_v2(&self,  params: GetRemediationsV2Params ) -> Result<models::DomainSpapiRemediationEntitiesResponseV2, Error<GetRemediationsV2Error>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::DomainSpapiRemediationEntitiesResponseV2`")))),
            }
        } else {
    ...
    async fn get_vulnerabilities(&self,  params: GetVulnerabilitiesParams ) -> Result<models::DomainSpapiVulnerabilitiesEntitiesResponseV2, Error<GetVulnerabilitiesError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::DomainSpapiVulnerabilitiesEntitiesResponseV2`")))),
            }
        } else {
