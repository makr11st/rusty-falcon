...
pub trait Api {
    ...
    fn admission_control_policies_api(&self) -> &dyn admission_control_policies_api::AdmissionControlPoliciesApi;
    ...
    fn certificate_based_exclusions_api(&self) -> &dyn certificate_based_exclusions_api::CertificateBasedExclusionsApi;
    fn cloud_aws_registration_api(&self) -> &dyn cloud_aws_registration_api::CloudAwsRegistrationApi;
    fn cloud_azure_registration_api(&self) -> &dyn cloud_azure_registration_api::CloudAzureRegistrationApi;
    fn cloud_connect_aws_api(&self) -> &dyn cloud_connect_aws_api::CloudConnectAwsApi;
    fn cloud_google_cloud_registration_api(&self) -> &dyn cloud_google_cloud_registration_api::CloudGoogleCloudRegistrationApi;
    fn cloud_oci_registration_api(&self) -> &dyn cloud_oci_registration_api::CloudOciRegistrationApi;
    ...
    fn cloud_security_compliance_api(&self) -> &dyn cloud_security_compliance_api::CloudSecurityComplianceApi;
    fn cloud_security_detections_api(&self) -> &dyn cloud_security_detections_api::CloudSecurityDetectionsApi;
    fn cloud_snapshots_api(&self) -> &dyn cloud_snapshots_api::CloudSnapshotsApi;
    fn configuration_assessment_api(&self) -> &dyn configuration_assessment_api::ConfigurationAssessmentApi;
    fn configuration_assessment_evaluation_logic_api(&self) -> &dyn configuration_assessment_evaluation_logic_api::ConfigurationAssessmentEvaluationLogicApi;
    ...
    fn container_image_compliance_api(&self) -> &dyn container_image_compliance_api::ContainerImageComplianceApi;
    ...
    fn container_vulnerabilities_api(&self) -> &dyn container_vulnerabilities_api::ContainerVulnerabilitiesApi;
    fn content_update_policies_api(&self) -> &dyn content_update_policies_api::ContentUpdatePoliciesApi;
    fn correlation_rules_api(&self) -> &dyn correlation_rules_api::CorrelationRulesApi;
    fn correlation_rules_admin_api(&self) -> &dyn correlation_rules_admin_api::CorrelationRulesAdminApi;
    ...
    fn data_protection_configuration_api(&self) -> &dyn data_protection_configuration_api::DataProtectionConfigurationApi;
    ...
    fn device_control_policies_api(&self) -> &dyn device_control_policies_api::DeviceControlPoliciesApi;
    fn device_control_with_bluetooth_api(&self) -> &dyn device_control_with_bluetooth_api::DeviceControlWithBluetoothApi;
    ...
    fn falcon_complete_dashboard_api(&self) -> &dyn falcon_complete_dashboard_api::FalconCompleteDashboardApi;
    ...
    fn falcon_container_image_api(&self) -> &dyn falcon_container_image_api::FalconContainerImageApi;
    ...
    fn image_assessment_policies_api(&self) -> &dyn image_assessment_policies_api::ImageAssessmentPoliciesApi;
    ...
    fn installation_tokens_settings_api(&self) -> &dyn installation_tokens_settings_api::InstallationTokensSettingsApi;
    fn intel_api(&self) -> &dyn intel_api::IntelApi;
    fn intelligence_feeds_api(&self) -> &dyn intelligence_feeds_api::IntelligenceFeedsApi;
    fn intelligence_indicator_graph_api(&self) -> &dyn intelligence_indicator_graph_api::IntelligenceIndicatorGraphApi;
    ...
    fn kubernetes_container_compliance_api(&self) -> &dyn kubernetes_container_compliance_api::KubernetesContainerComplianceApi;
    ...
    fn real_time_response_admin_api(&self) -> &dyn real_time_response_admin_api::RealTimeResponseAdminApi;
    fn real_time_response_audit_api(&self) -> &dyn real_time_response_audit_api::RealTimeResponseAuditApi;
    ...
    fn sensor_update_policies_api(&self) -> &dyn sensor_update_policies_api::SensorUpdatePoliciesApi;
    fn sensor_usage_api_api(&self) -> &dyn sensor_usage_api_api::SensorUsageApiApi;
    fn sensor_visibility_exclusions_api(&self) -> &dyn sensor_visibility_exclusions_api::SensorVisibilityExclusionsApi;
    fn serverless_vulnerabilities_api(&self) -> &dyn serverless_vulnerabilities_api::ServerlessVulnerabilitiesApi;
    fn spotlight_evaluation_logic_api(&self) -> &dyn spotlight_evaluation_logic_api::SpotlightEvaluationLogicApi;
    fn spotlight_vulnerabilities_api(&self) -> &dyn spotlight_vulnerabilities_api::SpotlightVulnerabilitiesApi;
    ...
    fn unidentified_containers_api(&self) -> &dyn unidentified_containers_api::UnidentifiedContainersApi;
