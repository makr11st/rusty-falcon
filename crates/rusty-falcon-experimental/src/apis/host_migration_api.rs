...
pub trait HostMigrationApi: Send + Sync {
    ...
    async fn create_migration_v1(&self,  params: CreateMigrationV1Params ) -> Result<models::ApiCreateMigrationResponseV1, Error<CreateMigrationV1Error>>;

    /// GET /host-migration/queries/host-migrations/v1
    ///
    /// Query host migration IDs.
    async fn get_host_migration_ids_v1(&self,  params: GetHostMigrationIdsV1Params ) -> Result<models::MsaspecQueryResponse, Error<GetHostMigrationIdsV1Error>>;
    ...
    async fn get_host_migrations_v1(&self,  params: GetHostMigrationsV1Params ) -> Result<models::ApiGetHostMigrationResponseV1, Error<GetHostMigrationsV1Error>>;

    /// POST /host-migration/entities/migration-destinations/GET/v1
    ///
    /// `device_ids` and `filter` are mutually exclusive.
    async fn get_migration_destinations_v1(&self,  params: GetMigrationDestinationsV1Params ) -> Result<models::ApiGetMigrationDestinationsResponseV1, Error<GetMigrationDestinationsV1Error>>;

    /// GET /host-migration/queries/migrations/v1
    ///
    /// 
    async fn get_migration_ids_v1(&self,  params: GetMigrationIdsV1Params ) -> Result<models::MsaspecQueryResponse, Error<GetMigrationIdsV1Error>>;

    /// GET /host-migration/entities/migrations/v1
    ///
    /// 
    async fn get_migrations_v1(&self,  params: GetMigrationsV1Params ) -> Result<models::ApiGetMigrationsResponseV1, Error<GetMigrationsV1Error>>;
    ...
    async fn host_migration_aggregates_v1(&self,  params: HostMigrationAggregatesV1Params ) -> Result<models::MsaAggregatesResponse, Error<HostMigrationAggregatesV1Error>>;
    ...
    async fn host_migrations_actions_v1(&self,  params: HostMigrationsActionsV1Params ) -> Result<models::MsaspecQueryResponse, Error<HostMigrationsActionsV1Error>>;
    ...
    async fn migration_aggregates_v1(&self,  params: MigrationAggregatesV1Params ) -> Result<models::MsaAggregatesResponse, Error<MigrationAggregatesV1Error>>;
    ...
    async fn migrations_actions_v1(&self,  params: MigrationsActionsV1Params ) -> Result<models::MsaspecQueryResponse, Error<MigrationsActionsV1Error>>;
}
...
impl HostMigrationApi for HostMigrationApiClient {
    ...
    async fn create_migration_v1(&self,  params: CreateMigrationV1Params ) -> Result<models::ApiCreateMigrationResponseV1, Error<CreateMigrationV1Error>> {
        ...
        let local_var_uri_str = format!("{}/host-migration/entities/migrations/v1", local_var_configuration.base_path);
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::ApiCreateMigrationResponseV1`")))),
            }
        } else {
            let local_var_entity: Option<CreateMigrationV1Error> = serde_json::from_str(&local_var_content).ok();
    ...
    async fn get_host_migration_ids_v1(&self,  params: GetHostMigrationIdsV1Params ) -> Result<models::MsaspecQueryResponse, Error<GetHostMigrationIdsV1Error>> {
        ...
        let local_var_uri_str = format!("{}/host-migration/queries/host-migrations/v1", local_var_configuration.base_path);
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetHostMigrationIdsV1Error> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_host_migrations_v1(&self,  params: GetHostMigrationsV1Params ) -> Result<models::ApiGetHostMigrationResponseV1, Error<GetHostMigrationsV1Error>> {
        ...
        let local_var_uri_str = format!("{}/host-migration/entities/host-migrations/GET/v1", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::ApiGetHostMigrationResponseV1`")))),
            }
        } else {
            let local_var_entity: Option<GetHostMigrationsV1Error> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_migration_destinations_v1(&self,  params: GetMigrationDestinationsV1Params ) -> Result<models::ApiGetMigrationDestinationsResponseV1, Error<GetMigrationDestinationsV1Error>> {
        ...
        let GetMigrationDestinationsV1Params {
            body,
        } = params;
        ...
        let local_var_uri_str = format!("{}/host-migration/entities/migration-destinations/GET/v1", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::ApiGetMigrationDestinationsResponseV1`")))),
            }
        } else {
            let local_var_entity: Option<GetMigrationDestinationsV1Error> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_migration_ids_v1(&self,  params: GetMigrationIdsV1Params ) -> Result<models::MsaspecQueryResponse, Error<GetMigrationIdsV1Error>> {
        ...
        let local_var_uri_str = format!("{}/host-migration/queries/migrations/v1", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetMigrationIdsV1Error> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_migrations_v1(&self,  params: GetMigrationsV1Params ) -> Result<models::ApiGetMigrationsResponseV1, Error<GetMigrationsV1Error>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::ApiGetMigrationsResponseV1`")))),
            }
        } else {
            let local_var_entity: Option<GetMigrationsV1Error> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn host_migration_aggregates_v1(&self,  params: HostMigrationAggregatesV1Params ) -> Result<models::MsaAggregatesResponse, Error<HostMigrationAggregatesV1Error>> {
        ...
        let HostMigrationAggregatesV1Params {
            body,
        } = params;
        ...
        let local_var_uri_str = format!("{}/host-migration/aggregates/host-migrations/v1", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<HostMigrationAggregatesV1Error> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn host_migrations_actions_v1(&self,  params: HostMigrationsActionsV1Params ) -> Result<models::MsaspecQueryResponse, Error<HostMigrationsActionsV1Error>> {
        ...
        let local_var_uri_str = format!("{}/host-migration/entities/host-migrations-actions/v1", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<HostMigrationsActionsV1Error> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn migration_aggregates_v1(&self,  params: MigrationAggregatesV1Params ) -> Result<models::MsaAggregatesResponse, Error<MigrationAggregatesV1Error>> {
        ...
        let MigrationAggregatesV1Params {
            body,
        } = params;
        ...
        let local_var_uri_str = format!("{}/host-migration/aggregates/migrations/v1", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<MigrationAggregatesV1Error> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn migrations_actions_v1(&self,  params: MigrationsActionsV1Params ) -> Result<models::MsaspecQueryResponse, Error<MigrationsActionsV1Error>> {
        ...
        let local_var_uri_str = format!("{}/host-migration/entities/migrations-actions/v1", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<MigrationsActionsV1Error> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
