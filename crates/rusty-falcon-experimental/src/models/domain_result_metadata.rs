...
pub struct DomainResultMetadata {
    #[serde(rename = "encrypted_report_file_reference")]
    pub encrypted_report_file_reference: String,
...
impl DomainResultMetadata {
    pub fn new(encrypted_report_file_reference: String, execution_delay: i64, execution_duration: i64, execution_finish: String, execution_start: String, queue_duration: i64, queue_start: String, report_file_name: String, report_finish: String, result_count: i32, result_id: String, search_window_end: String, search_window_start: String, use_ingest_time: bool) -> DomainResultMetadata {
        DomainResultMetadata {
            encrypted_report_file_reference,
            execution_delay,
            execution_duration,
            execution_finish,
            execution_start,
