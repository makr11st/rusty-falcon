...
pub struct RegistrationAwsAccountPatch {
    ...
    #[serde(rename = "vulnerability_scanning_enabled")]
...
impl RegistrationAwsAccountPatch {
    pub fn new(account_id: String, behavior_assessment_enabled: bool, dspm_enabled: bool, iam_role_arn: String, sensor_management_enabled: bool, vulnerability_scanning_enabled: bool) -> RegistrationAwsAccountPatch {
