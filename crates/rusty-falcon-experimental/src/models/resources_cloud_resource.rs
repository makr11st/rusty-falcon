...
pub struct ResourcesCloudResource {
    ...
    pub cloud_context: Option<models::ResourcesCloudContext>,
    ...
    #[serde(rename = "configuration_metadata", skip_serializing_if = "Option::is_none")]
    pub configuration_metadata: Option<serde_json::Value>,
