...
pub struct ItautomationTaskExecutionHostStatus {
    ...
    #[serde(rename = "it_automation_policy", skip_serializing_if = "Option::is_none")]
    pub it_automation_policy: Option<models::ItautomationPolicyStatus>,
    /// Reason for the current status. Example: In progress
    #[serde(rename = "reason", skip_serializing_if = "Option::is_none")]
    pub reason: Option<String>,
    #[serde(rename = "remote_response_policy", skip_serializing_if = "Option::is_none")]
    pub remote_response_policy: Option<models::ItautomationPolicyStatus>,
...
impl ItautomationTaskExecutionHostStatus {
    pub fn new(end_time: String, host_id: String, hostname: String, platform: String, stage: String, start_time: String, status: String, task_execution_id: String) -> ItautomationTaskExecutionHostStatus {
        ItautomationTaskExecutionHostStatus {
            ...
            status,
            task_execution_id,
            it_automation_policy: None,
            reason: None,
            remote_response_policy: None,
            total_results: None,
        }
    }
}
