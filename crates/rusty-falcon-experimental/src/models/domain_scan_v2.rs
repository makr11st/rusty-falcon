...
pub struct DomainScanV2 {
    ...
    pub filecount: Option<models::DomainFileCountV2>,
    ...
    #[serde(rename = "mac_cloud_ml_level_detection", skip_serializing_if = "Option::is_none")]
    pub mac_cloud_ml_level_detection: Option<i32>,
    #[serde(rename = "mac_cloud_ml_level_prevention", skip_serializing_if = "Option::is_none")]
    pub mac_cloud_ml_level_prevention: Option<i32>,
    #[serde(rename = "mac_cloud_pup_adware_level_detection", skip_serializing_if = "Option::is_none")]
    pub mac_cloud_pup_adware_level_detection: Option<i32>,
    #[serde(rename = "mac_cloud_pup_adware_level_prevention", skip_serializing_if = "Option::is_none")]
    pub mac_cloud_pup_adware_level_prevention: Option<i32>,
    #[serde(rename = "mac_file_paths", skip_serializing_if = "Option::is_none")]
    pub mac_file_paths: Option<Vec<String>>,
    #[serde(rename = "mac_policy_setting", skip_serializing_if = "Option::is_none")]
    pub mac_policy_setting: Option<Vec<i32>>,
    #[serde(rename = "mac_scan_exclusions", skip_serializing_if = "Option::is_none")]
    pub mac_scan_exclusions: Option<Vec<String>>,
    #[serde(rename = "mac_scan_inclusions", skip_serializing_if = "Option::is_none")]
    pub mac_scan_inclusions: Option<Vec<String>>,
    #[serde(rename = "mac_sensor_ml_level_detection", skip_serializing_if = "Option::is_none")]
    pub mac_sensor_ml_level_detection: Option<i32>,
    #[serde(rename = "mac_sensor_ml_level_prevention", skip_serializing_if = "Option::is_none")]
    pub mac_sensor_ml_level_prevention: Option<i32>,
    #[serde(rename = "mac_sensor_pup_adware_level_detection", skip_serializing_if = "Option::is_none")]
    pub mac_sensor_pup_adware_level_detection: Option<i32>,
    #[serde(rename = "mac_sensor_pup_adware_level_prevention", skip_serializing_if = "Option::is_none")]
    pub mac_sensor_pup_adware_level_prevention: Option<i32>,
...
impl DomainScanV2 {
    pub fn new(affected_hosts_count: i32, completed_host_count: i32, id: String, incomplete_host_count: i32, missing_host_count: i32, not_started_host_count: i32, started_host_count: i32, targeted_host_count: i32) -> DomainScanV2 {
        DomainScanV2 {
            ...
            initiated_from: None,
            last_updated: None,
            mac_cloud_ml_level_detection: None,
            mac_cloud_ml_level_prevention: None,
            mac_cloud_pup_adware_level_detection: None,
            mac_cloud_pup_adware_level_prevention: None,
            mac_file_paths: None,
            mac_policy_setting: None,
            mac_scan_exclusions: None,
            mac_scan_inclusions: None,
            mac_sensor_ml_level_detection: None,
            mac_sensor_ml_level_prevention: None,
            mac_sensor_pup_adware_level_detection: None,
            mac_sensor_pup_adware_level_prevention: None,
            max_duration: None,
            metadata: None,
            pause_duration: None,
            policy_setting: None,
