...
pub struct ItautomationScheduledTask {
    ...
    pub schedule: models::FalconforitapiSchedule,
...
impl ItautomationScheduledTask {
    pub fn new(created_by: String, created_time: String, groups: Vec<models::FalconforitapiGroupMembership>, id: String, is_active: bool, is_preset: bool, schedule: models::FalconforitapiSchedule, target: String, task_id: String, task_name: String, task_type: String) -> ItautomationScheduledTask {
