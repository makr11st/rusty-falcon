...
pub struct DomainAwsAccountV2 {
    ...
    pub d4c: Option<models::DomainAwsd4CAccountV1>,
    ...
    #[serde(rename = "ngsiem_enabled", skip_serializing_if = "Option::is_none")]
    pub ngsiem_enabled: Option<bool>,
    ...
    #[serde(rename = "vulnerability_scanning_enabled", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "vulnerability_scanning_role_arn", skip_serializing_if = "Option::is_none")]
    pub vulnerability_scanning_role_arn: Option<String>,
}
...
impl DomainAwsAccountV2 {
    pub fn new(created_at: String, deleted_at: String, id: i32, updated_at: String, aws_permissions_status: Vec<models::DomainPermission>, inventory_filter: Vec<models::DomainAwsInventoryFilterSetting>, is_custom_rolename: bool, sensor_management_enabled: bool) -> DomainAwsAccountV2 {
        DomainAwsAccountV2 {
            ...
            vulnerability_scanning_role_arn: None,
        }
    }
}
