...
pub struct JsonschemaSubSchema {
    ...
    pub x_cs_authorization: Option<models::JsonschemaAuthorization>,
    ...
    pub x_cs_condition_group_fields: Option<models::JsonschemaConditionGroupFields>,
    #[serde(rename = "x-cs-default-table-column", skip_serializing_if = "Option::is_none")]
    pub x_cs_default_table_column: Option<bool>,
    ...
    #[serde(rename = "x-cs-openapi", skip_serializing_if = "Option::is_none")]
    pub x_cs_openapi: Option<models::JsonschemaOpenApiExtensions>,
    ...
    pub x_cs_pivot: Option<models::JsonschemaPivot>,
    #[serde(rename = "x-cs-queryable", skip_serializing_if = "Option::is_none")]
    pub x_cs_queryable: Option<models::JsonschemaQueryConfig>,
    #[serde(rename = "x-cs-semantic-data", skip_serializing_if = "Option::is_none")]
    pub x_cs_semantic_data: Option<models::JsonschemaSemanticData>,
    #[serde(rename = "x-cs-signals", skip_serializing_if = "Option::is_none")]
    pub x_cs_signals: Option<models::JsonschemaSignalsExtensions>,
    ...
    pub x_cs_ui: Option<models::JsonschemaUiExtensions>,
    #[serde(rename = "x-cs-workflow", skip_serializing_if = "Option::is_none")]
    pub x_cs_workflow: Option<models::JsonschemaWorkflowExtensions>,
}
...
impl JsonschemaSubSchema {
    pub fn new() -> JsonschemaSubSchema {
        JsonschemaSubSchema {
            ...
            x_cs_default_table_column: None,
