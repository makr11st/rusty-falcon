...
pub struct SecurityCheckWithComplianceGetSecurityChecks {
    ...
    #[serde(rename = "check_tags")]
    pub check_tags: Vec<std::collections::HashMap<String, String>>,
