...
pub struct DomainDiscoverApiApplication {
    ...
    pub browser_extension: Option<models::DomainDiscoverApiApplicationBrowserExtension>,
    ...
    pub host: Option<models::DomainDiscoverApiApplicationHost>,
    ...
    #[serde(rename = "suspicious_indicators", skip_serializing_if = "Option::is_none")]
    pub suspicious_indicators: Option<Vec<models::DomainDiscoverApiSuspiciousIndicator>>,
